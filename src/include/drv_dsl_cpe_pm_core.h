...
#if defined(INCLUDE_DSL_FE_EOC_COUNTERS)
   /**
      Macro to get access to current EOC FE counters (Raw)
   */
   #define DSL_DRV_PM_PTR_FE_EOC_RAW_COUNTERS_CURR() \
      &(DSL_DRV_PM_CONTEXT(pContext)->pCounters->eocFeCounters)
#endif /* #if defined(INCLUDE_DSL_FE_EOC_COUNTERS)*/
...
{
   /** Far-End data*/
   DSL_PM_ChannelData_t data_fe[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
   /** Near-End data*/
   DSL_PM_ChannelData_t data_ne[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
#if defined (INCLUDE_DSL_CPE_PM_CHANNEL_EXT_COUNTERS)
   /** Near-End extended data*/
   DSL_PM_ChannelDataExt_t data_ne_ext[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
...
{
   /** Near-End data*/
   DSL_pmChannelThresholdCrossingData_t ind_ne[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
   /** Far-End data*/
   DSL_pmChannelThresholdCrossingData_t ind_fe[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
...
{
   /** Far-End data*/
   DSL_PM_DataPathData_t data_fe[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
   /** Near-End data*/
   DSL_PM_DataPathData_t data_ne[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
...
{
   /** Near-End data*/
   DSL_pmDataPathThresholdCrossingData_t ind_ne[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
   /** Far-End data*/
   DSL_pmDataPathThresholdCrossingData_t ind_fe[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
...
{
   /** Far-End data*/
   DSL_PM_DataPathFailureData_t data_fe[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
   /** Near-End data*/
   DSL_PM_DataPathFailureData_t data_ne[DSL_MAX_SUPPORTED_CHANNELS_PER_LINE];
...
#if defined (INCLUDE_DSL_FE_EOC_COUNTERS)
#define DSL_PM_EOC_FE_HDLC_16BIT_BUFF_LEN   (29)

typedef struct
{
   /** EOC counters are Valid*/
   DSL_boolean_t bValid;
   /** Raw FE EOC counters data*/
   DSL_uint16_t nFeEocRawCounters[DSL_PM_EOC_FE_HDLC_16BIT_BUFF_LEN];
} DSL_PM_FeEocCounters_t;
#endif /* #if defined (INCLUDE_DSL_FE_EOC_COUNTERS)*/
...
typedef struct
{
   ...
   DSL_PM_FeEocCounters_t eocFeCounters;
#endif /* INCLUDE_DSL_FE_EOC_COUNTERS*/
...
/**
   Structure for the PM VRX Device specific data
*/
