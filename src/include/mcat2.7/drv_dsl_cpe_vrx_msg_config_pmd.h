...
struct CMD_ModemFSM_Options2Set
{
   ...
   /** Trellis Support, Bit 5 */
   DSL_uint16_t enableTrellis : 1;
   /** OPTIONAL CIPOLICIES (currently VDSL only), Bit 4 */
   DSL_uint16_t CIPolicies1_2 : 1;
...
struct CMD_NoiseMarginDeltaSet
{
   ...
   /** Reserved (VDSL only) */
   DSL_uint16_t Res0 : 14;
   /** HW modification for NMS, Bit 1 (VDSL only) */
   DSL_uint16_t nms1 : 1;
   /** Noise Margin Separation (NMS) Control, Bit 0 (VDSL only) */
   DSL_uint16_t nms0 : 1;
#else
   /** Index */
   DSL_uint16_t Index;
