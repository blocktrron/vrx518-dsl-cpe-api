   ...
   DSL_uint32_t **ppCeocDynCntrl)
{
   ...
   if(*ppCeocDynCntrl != DSL_NULL)
   {
      DSL_DEBUG( DSL_DBG_ERR,
         (pContext, SYS_DBG_ERR"DSL[%02d]: ERROR - expecting zero context pointer '*ppCeocDynCntrl'!"
   ...
   {
      DSL_DEBUG( DSL_DBG_ERR,
         (pContext, SYS_DBG_ERR"DSL[%02d]: ERROR - can't allocate memory for '*ppCeocDynCntrl'!"
         DSL_DRV_CRLF, DSL_DEV_NUM(pContext)));
   ...
   DSL_uint32_t *pCeocDynCntrl)
{
   ...
   {
      DSL_DEBUG( DSL_DBG_ERR,
         (pContext, SYS_DBG_ERR"DSL[%02d]: ERROR - Attempt to close not existing device(%d)!"
         DSL_DRV_CRLF, DSL_DEV_NUM(pContext), pDynCtrl->currOpenInstance));
   ...
   DSL_CEOC_Message_t *pMsg)
{
   ...
   {
      DSL_DEBUG( DSL_DBG_ERR,
         (pContext, SYS_DBG_ERR"DSL[%02d]: ERROR - CEOC message send failed!"
         DSL_DRV_CRLF, DSL_DEV_NUM(pContext)));
   }
   ...
   DSL_CEOC_Callback_t pCallBackFunction)
{
   ...
   {
      DSL_DEBUG( DSL_DBG_ERR,
         (pContext, SYS_DBG_ERR"DSL[%02d]: ERROR - can't register CEOC callback, callback pointer is NULL!"
         DSL_DRV_CRLF, DSL_DEV_NUM(pContext)));
   ...
   {
      DSL_DEBUG( DSL_DBG_ERR,
         (pContext, SYS_DBG_ERR"DSL[%02d]: ERROR - can't register CEOC callback, elready registered!"
         DSL_DRV_CRLF, DSL_DEV_NUM(pContext)));
