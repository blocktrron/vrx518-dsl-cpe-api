   ...
   DSL_CEOC_Message_t *pMsg)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL[%02d]: IN - DSL_CEOC_FifoMessageRead"
      DSL_DRV_CRLF, DSL_DEV_NUM(pContext)));
   ...
   default:
      ...
      DSL_DEBUG(DSL_DBG_WRN, (pContext,
         SYS_DBG_WRN"DSL[%02d]: WARNING - Unsupported protocol identifier(0x%04X)!" DSL_DRV_CRLF,
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL[%02d]: OUT - DSL_CEOC_FifoMessageRead, retCode=%d"
      DSL_DRV_CRLF, DSL_DEV_NUM(pContext), nErrCode));
   ...
   DSL_CEOC_Message_t *pMsg)
{
   ...
   for( i = 0; i < DSL_DRV_DEVICE_NUMBER; i++ )
   {
