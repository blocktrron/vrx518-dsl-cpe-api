   ...
   adslLineTableEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG, (pContext, SYS_DBG_MSG"DSL: IN - "
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_LineEntryGet, "
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: IN - DSL_DRV_MIB_ADSL_PhysEntryGet"DSL_DRV_CRLF));
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_PhysEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAtucPhysEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucPhysEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAturPhysEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturPhysEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_ChanEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAtucChanInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucChanEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAturChanInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturChanEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_PerfDataEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   atucPerfDataEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucPerfDataEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   aturPerfDataEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturPerfDataEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_IntervalEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAtucIntvlInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucIntervalEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAturIntvlInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturIntervalEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_ChanPerfDataEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   atucChannelPerfDataEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucChanPerfDataEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   aturChannelPerfDataEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturChanPerfDataEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_ChanIntervalEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAtucChanIntvlInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucChanIntervalEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAturChanIntvlInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturChanIntervalEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslLineAlarmConfProfileEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_LineAlarmConfProfileEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslLineAlarmConfProfileEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_LineAlarmConfProfileEntrySet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
...
{
   DSL_Error_t nErrCode = DSL_SUCCESS;
   DSL_MIB_ADSL_Thresholds_t nFlags = DSL_MIB_TRAPS_NOTHING;
   ...
   *pData = (adslAturTrapsFlags_t)(nFlags & DSL_MIB_TRAPS_MASK_ADSL);
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_TrapsGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslLineExtTableEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_LineExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslLineExtTableEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_LineExtEntrySet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_PerfDataExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   atucPerfDataExtEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucPerfDataExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   aturPerfDataExtEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturPerfDataExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_void_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_IntervalExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAtucInvtlExtInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AtucIntervalExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAturInvtlExtInfo_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AturIntervalExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslLineAlarmConfProfileExtEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AlarmConfProfileExtEntryGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslLineAlarmConfProfileExtEntry_t *pData)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_AlarmConfProfileExtEntrySet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   adslAturExtTrapsFlags_t *pData)
{
   ...
   *pData = (adslAturExtTrapsFlags_t)((nFlags & DSL_MIB_TRAPS_MASK_ADSL_EXT) >> 9);
   ...
   DSL_DEBUG(DSL_DBG_MSG,
      (pContext, SYS_DBG_MSG"DSL: OUT - DSL_DRV_MIB_ADSL_ExtTrapsGet, "
      "nReturn(%d)"DSL_DRV_CRLF, nErrCode));
   ...
   DSL_uint32_t nArgSz)
{
   ...
   {
      DSL_DEBUG(DSL_DBG_ERR, (pContext, SYS_DBG_ERR"Invalid parameter was passed "
   ...
   DSL_uint32_t nArg)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG, (DSL_NULL, SYS_DBG_MSG"DSL: DSL_DRV_MIB_IoctlHandle: Call %d - "
   ...
   DSL_DEBUG(DSL_DBG_MSG, (DSL_NULL, SYS_DBG_MSG"DSL_DRV_MIB_IoctlHandle - "
   ...
   DSL_Context_t *pContext)
{
   ...
   DSL_DEBUG(DSL_DBG_MSG, (pContext, SYS_DBG_MSG"DSL_DRV_MIB_ModuleInit - "
      "Enter"DSL_DRV_CRLF));
